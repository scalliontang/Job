package com.sicongtang.job.servlet;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sicongtang.job.db.MySQLConnection;
import com.sicongtang.job.entity.LoginRequestBody;
import com.sicongtang.job.entity.LoginResponseBody;
...
public class LoginServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (connection.verifyLoging(body.userId, body.password)) {
