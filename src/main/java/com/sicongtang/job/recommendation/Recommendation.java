package com.sicongtang.job.recommendation;

import com.sicongtang.job.db.MySQLConnection;
import com.sicongtang.job.entity.Item;
import com.sicongtang.job.external.GitHubClient;
...
public class Recommendation {
    ...
    public List<Item> recommendItems(String userId, double lat, double lon) {
        ...
        //Step 3, search based on keywords, filter our favorite items
